        ...
        <>
            <section className="w-full pt-[180px]">
                <div className="max-w-7xl mx-auto lg:px-10">
                    <h1 className="text-center text-6xl text-black font-light pb-10">Meet The <span className="font-bold text-blue-600">Team</span>
                    </h1>
                    <p className="text-center text-4xl font-bold pb-6 text-red-500">Leadership</p>
                    <div className="flex flex-wrap justify-center gap-3 lg:gap-5">
                        ...
                        <div className="bg-slate-700 rounded-md w-48 p-5">
                            <img alt="person" loading="lazy" width="150" height="150" decoding="async" data-nimg="1" className="mx-auto p-1" src="https://randomuser.me/api/portraits/women/1.jpg"/>
                            <p className="text-lg w-40 text-center mx-auto font-bold text-white">Susi</p>
                            <p className="text-center text-white">Zimbabwe</p>
                        </div>
                        <div className="bg-slate-700 rounded-md w-48 p-5">
                            <img alt="person" loading="lazy" width="150" height="150" decoding="async" data-nimg="1" className="mx-auto p-1" src="https://randomuser.me/api/portraits/men/2.jpg"/>
                            <p className="text-lg w-40 text-center mx-auto font-bold text-white">Sumanto</p>
                            <p className="text-center text-white">Vrindavan</p>
                        </div>
                        <div className="bg-slate-700 rounded-md w-48 p-5">
                            <img alt="person" loading="lazy" width="150" height="150" decoding="async" data-nimg="1" className="mx-auto p-1" src="https://randomuser.me/api/portraits/women/3.jpg"/>
                    ...
                    <p className="text-center text-4xl font-bold pb-6 text-purple-600 pt-20">Creative</p>
                    <div className="flex flex-wrap justify-center gap-3 lg:gap-5">
                        <div className="bg-slate-700 rounded-md w-48 p-5">
                            <img alt="person" loading="lazy" width="150" height="150" decoding="async" data-nimg="1" className="mx-auto p-1" src="https://randomuser.me/api/portraits/women/3.jpg"/>
                            <p className="text-lg w-40 text-center mx-auto font-bold text-white">Sri</p>
